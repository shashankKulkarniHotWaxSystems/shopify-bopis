...
${errorInfo.componentStack}`);
  ...
  function Extension() {
    ...
    function convertListToFilterString(storeCodes2) {
      if (!Array.isArray(storeCodes2) || storeCodes2.length === 0) {
        return `storeCode: ()`;
      }
      const formattedValues = storeCodes2.join(" OR ");
      return `storeCode: (${formattedValues})`;
    }
    function getPickupStores(storeCodes2) {
      return __async(this, null, function* () {
        var _a;
        ...
        const payload = {
          ...
          filters: [
            ...
            convertListToFilterString(storeCodes2)
          ]
        };
        try {
          ...
          if (data == null ? void 0 : data.response) {
            return (_a = data == null ? void 0 : data.response) == null ? void 0 : _a.docs;
          }
    ...
    const stores = cartLine.filter((line) => {
      var _a;
      return ((_a = line == null ? void 0 : line.attributes) == null ? void 0 : _a.length) > 0;
    });
    const storeCodeData = getUniqueStores(
      stores.map(
        (line) => {
          var _a;
          return ((_a = line == null ? void 0 : line.attributes) != null ? _a : []).find((attr) => (attr == null ? void 0 : attr.key) === storeId);
        }
      )
    );
    const storeAddresses = getUniqueStores(
      stores.map(
        (line) => {
          var _a;
          return ((_a = line == null ? void 0 : line.attributes) != null ? _a : []).find((attr) => (attr == null ? void 0 : attr.key) === addressKey);
        }
      )
    );
    const storeCodes = storeCodeData.map((store) => store == null ? void 0 : store.value);
    (0, import_react13.useEffect)(() => {
      if (storeCodes.length > 0) {
        getPickupStores(storeCodes).then((res) => {
          setDeliveryAddress((res != null ? res : [])[0]);
        });
      }
    }, []);
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(import_jsx_runtime4.Fragment, { children: storeAddresses.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(BlockStack2, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Heading2, { children: "Selected Pickup Stores" }),
      storeAddresses.map((store) => /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(TextBlock2, { children: store && (store == null ? void 0 : store.value) }, (store == null ? void 0 : store.key) + (store == null ? void 0 : store.value)))
    ] }) });
  }
})();
//# sourceMappingURL=my-checkout-extension.js.map
